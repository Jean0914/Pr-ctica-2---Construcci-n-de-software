...
- **Diseño Glassmorphism**: Interfaz moderna con "Dark Mode", efectos de cristal y micro-animaciones.
- **Base de Datos Ligera**: Utiliza SQLite para una configuración rápida sin necesidad de servidores externos.
